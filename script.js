function clickedMe() {
  ...
  var card3 = (document.getElementById('dikshi3').innerHTML = '');

  card3 = document.createElement('div');

  card3.className = 'card  border-0';

  let cardBody3 = document.createElement('div');
  cardBody3.className = 'card-body';

  let title3 = document.createElement('h5');
  title3.innerText = 'I will explain or';
  title3.className = 'card-title';

  let color3 = document.createElement('div');
  color3.innerText = 'She wants to be pardoned,no fuzzy flattery is born';
  color3.className = 'black';

  cardBody3.appendChild(title3);
...
function clickedMe2() {
  document.getElementById('dikshi2');
  var card = (document.getElementById('dikshi2').innerHTML = '');
  ...
  let title = document.createElement('h5');
  title.innerText = 'The Source Of The Present';
  title.className = 'card-title';

  let color = document.createElement('div');
  color.innerText = 'Pleaseure or repedition by which to catch him';
  color.className = 'black';

  cardBody.appendChild(title);
  cardBody.appendChild(color);
  card.appendChild(cardBody);
  dikshi2.appendChild(card);
  document.getElementById('img1').src =
    'https://bootstrapmade.com/demo/templates/Maxim/assets/img/features-2.png';

  //Make card 1 as original card
